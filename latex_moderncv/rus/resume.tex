...
\section{Технологии}
\cvline
{}{python, langchain, langgraph, pydanticai, оптимизация, данные, машинное обучение, computer vision, NLP, статистика, numpy, pandas, PostgreSQL, ClickHouse, scipy, transformers, pytorch, C++, Rust, Docker.}
\section{Опыт}
\vline
\cventry{2025 Окт — }{ML-инженер}{Techcore}{Санкт-Петербург, Россия}{}{Занимался разработкой агентных систем с помощью langgraph, pydanticai. Создал агента с UI в тг-боте со сбором, обработкой и анализу финансовых отчётов компаний для последующего анализа облигаций и акций золота. Для анализа был создан RAG-пайплайн с собственной стратегией семантического чанкинга (chonkie + custom). Написал свой MCP-сервер для онлайн-поиска. Отслеживание латенси, unexpected behaivour, лимитов и алерты с помощью Langsmith и Logfire. \\
	Создал несколько мультиагентных систем с RAG для поиска юридической документации компании и ответов на вопросы. OCR и fitz для парсинга и обработки документов. Развернул как микросервис в Я.Облако на k8s.\\
Управлял командой по созданию прогнозных приложений для нужд маркетплейсов, менторил стажёров.}
\vline
...
{NLLB, Qwen3, парсинг словарей и книг. \href{https://github.com/breadfan/kielven_project}{Github}
...
%	As a course work for third year two methods were implemented: MDM and accelerated MDM methods with visualization for 2- and 3-dim. Cases for running time comparison.}
  ...
  {ММ по NLP, оптам, DL. На русском и английском. \href{https://github.com/breadfan/mindmaps-for-everything}{Github}
%  	Создал майндмапы для лучшего понимания и запоминания предметов (вдохновлялся «Цеттелькастеном»). В репозитории есть мапы для статистики, NLP, оптимизации и глубокого обучения, доступны на русском и английском языках.
  ...
  \cvline{Рекомендер музыки по её тексту}
  {doc2vec+distilbert, hnsw, тг-бот для ui. \href{https://github.com/breadfan/lyrics-based-songs-recommender}{Github}
